...
CREATE TABLE recipes(id INT PRIMARY KEY DEFAULT NEXTVAL('recipes_ids'), name VARCHAR(100), preparation TEXT, preparation_time INTEGER,recipe_types VARCHAR(150), image VARCHAR(100), smart_points INTEGER);
...
CREATE TABLE ingredients(id INT PRIMARY KEY DEFAULT NEXTVAL('ingredients_ids'), name VARCHAR(100), picture_url VARCHAR(100));
...
INSERT INTO users (username, password, email, active) VALUES ('user1', '1234', 'user@google.com', 'true');
